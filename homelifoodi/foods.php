                        ...
                        <div class="displaycard">
                            ...
                            <div class="displaytext">
                                ...
                                <!-- <div class="fdquantity">
                                    ...
                                    <input type="number" min="1" name="qty" id="" value="qty" min="1">
                                </div>  -->
                                <div class="addcartbtn">
                                    <a href="db.php?product_id=<?php echo $result['prdt_id']?>&login_id=<?php echo $reslt['login_id']?>">
                                    <!-- <input type="submit" name="cart" value="Add to cart"></a> -->
                                    <button type="button" class="btn" name="submit" >Add to cart</button></a>
                                </div>
                            </div>
                        </div>
                    </form>
